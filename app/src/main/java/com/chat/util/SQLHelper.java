...
public class SQLHelper {
	...
	public static final String CONTACT_LIST_QUERY = "select contact_id, contact_first_name, contact_last_name, contact_user_id, blocked, country_code, mobile_number from contact a join user_info b on a.contact_user_id = b.user_id where a.created_user_id = ?";
	...
	public static final String UPDATE_CHAT_QUERY = "Update chat set last_message_sent_time = getdate(), last_message_content = ?, last_message_by = ? "
