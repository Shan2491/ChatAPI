...
public class SQLHelper {
	...
	public static final String INSERT_USER_INFO_QUERY = "Insert into user_info ( user_id, user_first_name, user_last_name, country_code, mobile_number, created_time) values (?,?,?,?, ?,getdate())";
